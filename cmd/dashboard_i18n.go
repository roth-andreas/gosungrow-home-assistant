...
var defaultDashboardLocaleBundle = dashboardLocaleBundle{
	Dashboard: map[string]string{
		...
		"source_match_update":           "A safer automatic source is available.",
		"source_match_unverified":       "The current automatic source could not be verified.",
		"source_adopted":                "Automatic source updated.",
		"source_legacy_automatic":       "Legacy automatic — review required",
